    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Text style={styles.catchyText}>
          Indulge in the deliciousness of handcrafted meals made with love and fresh ingredients. Every bite tells a story!
        </Text>
        ...
        {searchQuery ? (
          <View style={styles.section}>
            {filteredItems.length > 0 ? (
              <FlatList
                ...
                renderItem={({ item }) => (
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      navigateToItem(item.category, item.title);
                      setSearchQuery('');
                    }}
                  >
              ...
              <Text style={styles.noResultsText}>no item found</Text>
            )}
          </View>
        ) : (
          <View style={styles.section}>
